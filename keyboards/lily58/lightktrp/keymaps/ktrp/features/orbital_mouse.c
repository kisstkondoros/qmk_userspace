...
static int16_t scaled_sin(uint8_t amplitude, uint8_t phase) {
    ...
    static const uint8_t lut[NUM_ANGLES / 2] PROGMEM = {0, 25, 50, 74, 98, 120, 142, 162, 180, 197, 212, 225, 236, 244, 250, 254, 255, 254, 250, 244, 236, 225, 212, 197, 180, 162, 142, 120, 98, 74, 50, 25};
