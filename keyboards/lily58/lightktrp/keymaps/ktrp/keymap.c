 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |      |      |      |      |                    | w_u  |click | forw |2click| PSCR | F12  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------.    ,-------| w_d  | rotl |backw | rotr |      | fast |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------| rel  | hold | sel1 | sel2 | sel3 | slow |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |      |      |      | /       /       \      \  |      |  DEL |      |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
...
[_LOWER] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                   OM_W_U , OM_BTNS, OM_U   , OM_DBLS, KC_PSCR,  KC_F12,
  _______, _______, _______, _______, _______, _______,                   OM_W_D , OM_L   , OM_D   , OM_R   , XXXXXXX, OM_FAST,
  _______, _______, _______, _______, _______, _______, _______, _______, OM_RELS, OM_HLDS, OM_SEL1, OM_SEL2, OM_SEL3, OM_SLOW,
